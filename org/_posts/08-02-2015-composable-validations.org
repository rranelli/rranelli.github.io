...
#+INCLUDE: ../../_code/validator.hs src haskell
    ...
    the [[https://hackage.haskell.org/package/Validation-0.2.0/docs/Data-Validation.html][Haskell standard library]] both consider
    validations as [[https://wiki.haskell.org/Applicative_functor][Applicative Functors]] which are more general (i.e. put on less
...
#+INCLUDE: ../../_code/validator.rb src ruby

    And the =RSpec= tests:

#+INCLUDE: ../../_code/validator_spec.rb src ruby
...
#+INCLUDE: ../../_code/product_manager_validator.rb src ruby
...
#+INCLUDE: ../../_code/refactored_product_manager_validator.rb src ruby
...
*** Monoids and even more abstract nonsense
    ...
    Semigroups. I won't discuss them here because many [[http://blog.sigfpe.com/2009/01/haskell-monoids-and-their-uses.html][others]] have [[http://apfelmus.nfshost.com/articles/monoid-fingertree.html][already]]
    ...
    <link>. Seriously, Avdi's content is top-notch. Also, the [[http://devchat.tv/ruby-rogues/][ruby-rogues]]
