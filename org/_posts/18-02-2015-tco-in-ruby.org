...
* Tail Call Optimization in Ruby
  ...
  *TL;DR*: In a previous [[http://{{site.url}}/2015/01/31/missing-tco-in-ruby/][post]] I ranted about how I got bitten by the lack of [[http://en.wikipedia.org/wiki/Tail_call][TCO]]
