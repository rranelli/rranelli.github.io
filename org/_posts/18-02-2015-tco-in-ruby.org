...
*** A non-aesthetic problem
    ...
    assignment of the [[https://www.coursera.org/course/algo][algorithms course]], we're asked to implement
    [[http://en.wikipedia.org/wiki/Kosaraju's_algorithm][Kosaraju's algorithm]]
    for computing [[http://en.wikipedia.org/wiki/Strongly_connected_component][SCCs]] (strongly connected components). This implementation must
